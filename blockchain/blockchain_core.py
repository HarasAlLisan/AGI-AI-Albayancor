...
class AnkhSovereignBlockchain:
    ...
    MIZAN_GENESIS = "A1:1=19" # فاتحة الكتاب
    ...
    def initialize_financial_command(self):
        ...
        print(f"[+] Total Vault: {self.TOTAL_VAULT:,} {self.TOKEN_SYMBOL} - 2026...")
        ...
        print("="*70)
        print("[✓] ميزان القارات السبعة:")
        print(json.dumps(metrics, indent=2, ensure_ascii=False))
        print("="*70)

        # 7 قارات - كل قارة ليها genesis
        chain = []
        for i, cont in enumerate(self.CONTINENTS, 1):
            ...
            print(f"[🔒] قارة {i}/7 {cont}: AdamHash: {sovereign_hash[:32]}...")
